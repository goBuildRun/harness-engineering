...
from harness_runtime import canonical_digest, now, task_operation_lock
...
from harness_planning_support import (
    _existing_work_item,
    _gate,
    _local_work_item_id,
    _public_work_item,
...
def main() -> int:
    from harness_planning_cli import main as cli_main
    return cli_main()
