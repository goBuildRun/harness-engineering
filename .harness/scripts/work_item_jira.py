...
from work_item_providers import DEFAULT_HARNESS_NAME, WorkItem, WorkItemProvider, valid_id
    ...
    def _adf(text: str) -> dict[str, Any]:
        return {
            ...
            "content": [
                {
                    "type": "paragraph",
                    "content": [{"type": "text", "text": text or f"Created by {DEFAULT_HARNESS_NAME}"}],
                }
            ],
        }
