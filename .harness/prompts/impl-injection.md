...
- 写**任何**业务文件前：`bash .harness/scripts/structure_guard.sh --path <完整相对路径>`
- 写完后：`bash .harness/scripts/structure_guard.sh --diff`
...
- 沙箱：`bash .harness/scripts/run_in_sandbox.sh '<test>'`
- 连续失败：`bash .harness/scripts/gstack_investigate.sh '假说…'`
