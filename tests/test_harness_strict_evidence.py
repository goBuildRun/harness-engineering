...
from harness_strict_evidence import COMPONENT_SCHEMA, validate  # noqa: E402
    ...
    def test_expected_provider_and_complete_digest_chain_pass(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.dict(os.environ, {
                "HARNESS_STRICT_EVIDENCE": str(receipt),
            }), mock.patch(
                "harness_strict_evidence.trust_from_installation",
