...
from ael_knowledge import check_planning, sync_planning  # noqa: E402
...
""".lstrip(),
            ...
            plan = product / "ael-workspace" / "planning" / "exec-plans" / "active" / "demo-plan.md"
...
""".lstrip(),
            ...
            card = product / "ael-workspace" / "planning" / "tasks" / "2026-06-21-task-demo" / "00-任务卡.md"
...
""".lstrip(),
            ...
            artifact = product / "ael-workspace" / "bmad-output" / "planning-artifacts" / "architecture.md"
...
""".lstrip(),
            ...
            design = product / "ael-workspace" / "bmad-output" / "design-artifacts" / "ux-flow.md"
...
""".lstrip(),
        ...
        self.assertIn("BEGIN buildrun-agent-engineering-lifecycle:planning-context", context)
    ...
    def test_sync_planning_indexes_collected_artifacts_beyond_twenty(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            product = Path(tmp)
            write_project_config(product)
            artifacts = product / "ael-workspace" / "bmad-output" / "planning-artifacts"
