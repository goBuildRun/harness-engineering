...
from harness_provider_preflight import (  # noqa: E402
    argv_digest,
    execute_preflight,
    validate_receipt,
    verify,
)
from harness_gate_manifest import GateInputError  # noqa: E402
...
class HarnessProviderPreflightTest(unittest.TestCase):
    ...
    def test_dependency_parse_failure_preserves_structured_reason(self) -> None:
        with mock.patch(
            "harness_provider_preflight.execution_dependency_digest",
