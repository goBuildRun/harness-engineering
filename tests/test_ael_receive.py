...
from ael_gc_context import build_gc_context  # noqa: E402
from ael_gc_receipt import build_receipt, store_receipt  # noqa: E402
from ael_receive import _export_submodules, accept_updates, commits_for_update, verify_updates  # noqa: E402
from ael_runtime import default_result, mechanical_code_health, policy_for  # noqa: E402
...
class HarnessReceiveTest(unittest.TestCase):
    ...
    def test_receive_recomputes_commit_result_without_network_or_workspace_writes(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertFalse((repo / "ael-workspace").exists())
    ...
    def test_receive_materializes_submodule_from_explicit_local_object_source(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch("ael_receive.run_gate_plan", side_effect=gates):
    ...
    def test_receive_does_not_trust_client_gc_agent_claim(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch("ael_receive.run_gate_plan", return_value={
