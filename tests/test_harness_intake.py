...
from harness_intake import table_rows  # noqa: E402
from harness_intake_policy import skip_file  # noqa: E402


class HarnessIntakeTest(unittest.TestCase):
    def test_intake_modules_keep_single_responsibility_size(self) -> None:
        for name in (
            "harness_intake.py", "harness_intake_policy.py",
            "harness_intake_review.py", "harness_intake_scan.py",
        ):
