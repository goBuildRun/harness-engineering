...
from ael_attestation import commit_subject, create_attestation, verify_attestation  # noqa: E402
from ael_runtime import canonical_digest, default_result  # noqa: E402
...
class HarnessAttestationTest(unittest.TestCase):
    ...
    def test_result_cannot_attest_a_commit_with_different_content(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(outcome["reason"], "AEL_RESULT_SUBJECT_MISMATCH")
