...
| HDC-010 | 三级保障接入验收 | partially done：local/guarded、bare Git receive 阻断、acceptance receipt、provider 消费与 authority audit 已用真实 push 验证；触发独立 GC 的 commit 当前 fail closed，待 E1-S4 将 GC receipt 纳入 authority trust root 后才覆盖所有 tier |
