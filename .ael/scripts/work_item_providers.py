...
from work_item_provider_config import (
    DEFAULT_AEL_NAME as DEFAULT_AEL_NAME,
    ...
    load_ael_name as load_ael_name,
...
def resolve_product_spec_path(ael_root: Path, product_root: Path, spec: str) -> tuple[Path, str]:
    ...
    layout = load_layout(ael_root, product_root)
...
def get_provider(ael_root: Path) -> WorkItemProvider:
