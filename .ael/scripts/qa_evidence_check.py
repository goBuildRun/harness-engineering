...
from ael_execution_authority import (
...
from ael_runtime import canonical_digest, load_result, policy_for, subject_for
...
def validate_reviewer_identity(
    ...
    try:
        trust = trust_from_installation(
            ael_root or Path(__file__).resolve().parents[2],
...
def _validate_v2_binding(
    ...
    expected_policy = policy_for(layout.ael_root, layout.product_root)
