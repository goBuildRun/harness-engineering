...
from ael_gate_argv import command_executes_path
...
RECEIPT_SCHEMA = "harness-provider-preflight-receipt-v2"
...
def verify(
    ...
    if not _valid_digest(adapter_digest) or not _valid_digest(canonical_argv_digest):
...
def execute_preflight(
    ...
    env = {
        **os.environ,
        "AEL_PROVIDER_OFFLINE_TRACE": "1",
        "AEL_PROVIDER_EXPECTED_SUBJECT": expected_subject,
        "AEL_PROVIDER_NAME": provider.strip().lower(),
    }
    try:
