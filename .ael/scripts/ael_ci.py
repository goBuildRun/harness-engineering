#!/usr/bin/env python3
"""Commit-bound CI validation for the AEL runtime."""
...
from ael_cache import executed_check, tool_digest
from ael_gates import committed_work_item, run_gate_plan
...
from ael_telemetry import apply_gc_telemetry, apply_usage_receipt, enforce_budget
...
def cmd_ci_check(args: argparse.Namespace) -> int:
    ...
    ci_tools = tool_digest([
        harness / ".ael/scripts/ael_runtime.py",
        harness / ".ael/scripts/ael_scope.py",
        harness / ".ael/scripts/ael_cache.py",
    ])
