#!/usr/bin/env python3
"""CLI assembly for the lean AEL runtime."""
...
from ael_commands import cmd_amend, cmd_ci_check, cmd_finish, cmd_start, cmd_status
from ael_cycle_commands import cmd_confirm, cmd_release_ready, cmd_stage, cmd_usage_baseline
from ael_assurance import create_bootstrap, create_release_candidate
from ael_runtime import load_result, resolve_task_id, result_path
from ael_migration_commands import cmd_audit, cmd_migrate
from ael_runtime import TIERS
from ael_output import decision_exit_code, dump_json, reset_decision
...
def build_parser() -> argparse.ArgumentParser:
    ...
    start.add_argument(
        "--kind", choices=("implementation", "debt-maintenance", "scope-change", "hotfix", "ael-maintenance"),
    ...
    amend.add_argument("--kind", choices=("implementation", "debt-maintenance", "scope-change", "hotfix", "ael-maintenance"), default="")
