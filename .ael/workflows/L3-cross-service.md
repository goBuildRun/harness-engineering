...
1. `$PRODUCT_ROOT/ael-workspace/planning/product-specs/` + `$PRODUCT_ROOT/ael-workspace/planning/exec-plans/active/`
...
4. 建 `$PRODUCT_ROOT/ael-workspace/planning/tasks/YYYY-MM-DD-<work-item-id>-<简称>/` 全套 `00`～`06`
